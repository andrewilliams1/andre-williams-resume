...
\section{\faPieChart}{Experience}
 ...
 \resumeEntryStart
    \resumeEntryTSDL
      {General Dynamics Information Technology Inc.}{Apr 2025 -- Present}
      {DevSecOps Lead}{Tampa, FL}
    \resumeItemListStart
      \resumeItem {Spearheaded the deployment of United States Central Command's (USCENTCOM) first enterprise DevSecOps platform using GitLab Ultimate and Harbor Container Registry, enabling secure, automated CI/CD pipelines that streamlined software delivery across the organization.}
      \resumeItem {Integrated and configured advanced security scanning tools such as Semgrep, Hadolint, Syft, and Trivy into CI/CD workflows, automating the detection of vulnerabilities in source code, container images, and dependencies, reducing security risks by proactively addressing issues during development.}
      \resumeItem {Created CI/CD pipeline templates to provide reproducible pipeline configurations for use across all projects, automating job configuration based on repository structure and content.}
    \resumeItemListEnd
  \resumeEntryEnd

 \resumeEntryStart
    \resumeEntryTSDL
      {CACI International Inc.}{Apr 2024 -- APR 2025}
...
\section{\faGears}{Technical Skills}
 \resumeEntryStart
  \resumeEntryS{Programming Languages } {C\#, JavaScript, HTML, CSS, Python, Powershell, SQL}
  \resumeEntryS{Technologies/Frameworks } {Containerization, ASP .Net 8 / 6 / MVC 5 / Web Forms, Entity Framework Core / 6}
  \resumeEntryS{Tools } {Git, Docker, Microsoft Azure Cloud Services, Google Cloud Platform, Amazon Web Services}
